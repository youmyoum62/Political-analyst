...
# ────────────────────────────────────────────────────────────────────────────
#   委員会系: 委員長/会長=会議体の長(5.0)、理事/幹事=運営補佐(2.0)。
#     「会長」「幹事」は参議院 調査会の役職で、それぞれ委員長・理事に相当する
#     （参議院規則上、調査会長は委員長と同格の議事主宰権を持つ）。
ROLE_LEVEL_WEIGHTS: dict[str, float] = {
    "議長": 10.0,       "副議長": 8.0,
    "委員長": 5.0,      "会長": 5.0,         "特別委員長": 4.0,   "副委員長": 3.0,
    "筆頭理事": 2.5,    "理事": 2.0,          "幹事": 2.0,         "委員": 1.0,
